...
public class NodeResource {
	...
	public Response add(@PathParam("id") String id, @PathParam("value") String value) {
		return new NodeService(headers, uriInfo).addBinding(id, value);
	}
	...
	public Response delete(@PathParam("id") String id, @PathParam("value") String value) {
		return new NodeService(headers, uriInfo).deleteBinding(id, value);
	}
	
	@GET
	@Path("{key}")
	@Produces("application/xml")
	public Response getBinding(@PathParam("key") String key) {
